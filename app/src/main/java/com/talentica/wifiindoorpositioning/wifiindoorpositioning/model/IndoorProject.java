...
public class AccessPoint implements Parcelable {
    ...
    public double getMeanRss() { return meanRss; }

    public void setMeanRss(double meanRss) { this.meanRss = meanRss; }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        // Note: createdAt not parceled; add if needed
    }
    ...
    public static final Creator<AccessPoint> CREATOR = new Creator<AccessPoint>() {
        @Override
        public AccessPoint createFromParcel(Parcel in) { return new AccessPoint(in); }

        @Override
        public AccessPoint[] newArray(int size) { return new AccessPoint[size]; }
    };
}
```
